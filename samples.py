...
def main():
    ...
    gen("lora.hacker.png", prompt="toy_face of a hacker with a hoodie")

    for lora_scale in range(0, 121, 25):
        gen(
            f"lora.{lora_scale}.png",
            prompt="toy_face of a hacker with a hoodie",
            lora_scale=lora_scale/120.0,
            seed=1000,
        )
    ...
    gen(
        ...
        prompt="toy_face A studio portrait photo of a cat",
    ...
    for refiner in ["base_image_refiner", "expert_ensemble_refiner", "no_refiner"]:
        gen(
            ...
            prompt="toy_face a photo of an astronaut riding a horse on mars",
        ...
        gen(
            ...
            prompt="toy_face A majestic tiger sitting on a bench",
